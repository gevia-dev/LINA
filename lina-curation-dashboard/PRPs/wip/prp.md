...
**Feature Goal**: Preciso que você corrija o posicionamento dos "handles" / "conexões" dos nodes do meu advanced canvas. As linhas que os conectam não estão bem encaixadas, principalmente quando estou dragging e tenho que encaixar na outra. Existem vários exemplos de como fazer isso bem com o reactflow na internet

**Deliverable**: Nodes do advanced canvas tenham handles que encaixem perfeitamente nos lugares definidos, além de suas linhas também serem bem definidas.

**Success Definition**: Me perguntando após aplicar a sua solução e estar preparado para iterar até a resposta completa. *Debugs são importantes.*

## Why

- A animação está muito mal feita, o que causa estranhamento visual

## What

- As linhas dos handles de conexão dos nodes não funcionam.

### Success Criteria

- Código seguindo padrões de outros saas que usam o reactflow para os handles e debugs intuitivos no console para iteração comigo.
